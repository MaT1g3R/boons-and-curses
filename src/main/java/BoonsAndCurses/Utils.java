...
public class Utils {
    ...
    public static void spawnRelicAndObtain(AbstractRelic r) {
        AbstractDungeon.getCurrRoom()
                .spawnRelicAndObtain((float) (Settings.WIDTH / 2), (float) (Settings.HEIGHT / 2), r);
        r.onEquip();
    }

    public static void spawnRelicAndObtain(AbstractRelic.RelicTier tier) {
        AbstractRelic r = AbstractDungeon.returnRandomRelic(tier);
        spawnRelicAndObtain(r);
    }
}
